...
def main():
    ...
    # task_id: str = "48a0c10c-8b39-460d-9b91-451023b4a638"
    ...
    for planner_idx, recording_idx in PLANNER_IDX_TO_RECORDING_IDX.items():
        ...
        dom_repr: DomRepresentation = make_dom_representation(
            ...
            MAX_NODE_REPR_LENGTH=32768  # 16384*2  # This to operate with GPT o1 (2 ** 15)
            # MAX_NODE_REPR_LENGTH=2 ** 18  # I was trying this with Gemini.
        )
        ...
        """
        Pseudocode of Candidate Spider Generation.

        For each ROI HTML:

        1) Classify ROI HTML
        2) Generate candidate spider code
        """
        ...
        With Gemini, rate limits may be a problem:
        ...
        With Gemini, the prompt used with GPT to replace URLs for local ones
        in ctxexec don't work as expected.
        """

        # ctxexec.pipeline, line 21: if chunk is not None and chunk.spider_code not in [None, ""]:
